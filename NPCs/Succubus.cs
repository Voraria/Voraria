...
namespace VoreMod.NPCs
{
    ...
    public class Succubus : ModNPC
    {
        ...
        public override string Texture => nameof(VoreMod) + "/NPCs/" + nameof(Succubus);
        ...
        {
            if (Main.rand.Next(8) == 0) Item.NewItem(npc.getRect(), ItemID.DemonScythe);
        }
