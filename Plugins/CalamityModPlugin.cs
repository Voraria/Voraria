    ...
    public class CalamityModPlugin : VorePlugin
    {
        ...
        public override Builder Build(Builder builder) => builder
            .NPC("FAP", npc => npc
                ...
                .Dialogue(DialogueType.NonFatalOther, "God, my back hurts so much more with this chump hanging off me.")
                ...
                .Dialogue(DialogueType.PlayerTalisman, "A nap? Inside me? Alright, but fair warning, kid: once you go in there, you might not get back out...")
            )
